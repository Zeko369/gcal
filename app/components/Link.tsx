...
export const LinkButton: React.FC<LinkButtonProps> = ({ as, href, children, ...props }) => {
  return (
    <NextLink href={href} passHref as={as}>
      <Button as="a" {...props}>
        {children}
...
export const LinkIconButton: React.FC<LinkButtonIconProps> = ({ as, href, children, ...props }) => {
  return (
    <NextLink href={href} passHref as={as}>
